...
from app import app
import apps.functions as glbFuncs
...
def show_cluster(cluster_nr, data, listOfFrei, listOfFest, col):
    ...
    for fest in listOfFest:
        ...
        charts.append(dbc.Col(html.Div([dcc.Graph(figure = glbFuncs.getPie(pie_value, df), style={'margin-top' : '40px'})]), width=6))
                    ...
                    dbc.Card([
                        dbc.CardBody([
                            ...
                            dbc.Row([
                                ...
                                html.P(glbFuncs.summary(summarizeTheText), className='card-text2')                                
                            ], style={'margin-left':'3px'}),
                        ])
